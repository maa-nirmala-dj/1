...
<a href="javascript:void(0)" class="side-link premium-animated-btn" onclick="try{ if(typeof toggleMenu === 'function') toggleMenu(); }catch(e){} openAdvanceFeaturesModal()">
    <i class="fas fa-headset fa-pulse"></i> Advance Features
</a>

<div id="advanceFeaturesModalOverlay" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(5, 5, 8, 0.95); backdrop-filter:blur(10px); z-index:999999; justify-content:center; align-items:center; animation:fadeInOverlay 0.3s ease;" onclick="closeAdvanceOnOutsideClick(event)">
    
    <div class="mn-advance-box" id="advanceFeaturesBoxContent">
        
        <span onclick="closeAdvanceFeaturesModal()" style="position:absolute; top:15px; right:20px; color:#D4AF37; font-size:35px; line-height:1; cursor:pointer; transition:0.3s; z-index: 100;">&times;</span>
        
        <h2 style="font-family:'Cinzel',serif; color:#00e5ff; text-align:center; margin-top:0; border-bottom:1px solid rgba(0, 229, 255, 0.3); padding-bottom:15px; font-size: 24px; font-weight:800; letter-spacing:1px;">
            <i class="fas fa-microchip"></i> Advance Features
        </h2>
        <p style="color:#aaa; text-align:center; font-family:'Outfit', sans-serif; font-size:13px; margin-bottom:20px;">
            Control Premium UI, Languages, & Telegram Manager Live Radar
        </p>
        
        <div style="max-height: 65vh; overflow-y: auto; padding-right: 10px;" class="custom-scroll">
            
            <div class="settings-category">
                <h3 style="color:#D4AF37; font-family:'Cinzel',serif; font-size:16px; margin-top:0; border-bottom:1px dashed rgba(212,175,55,0.3); padding-bottom:10px;"><i class="fas fa-paint-roller"></i> Visual Customization</h3>
                
                <div class="setting-row">
                    <div class="setting-label"><div class="setting-icon" style="color:#00e5ff;"><i class="fas fa-language"></i></div><div>Global Language</div></div>
                    <div id="google_translate_element_advance"></div>
                </div>

                <div class="setting-row">
                    <div class="setting-label"><div class="setting-icon" style="color:#D4AF37;"><i class="fas fa-font"></i></div><div>Font Styling</div></div>
                    <select class="s-input" style="width:130px; margin-bottom:0; padding:8px;" onchange="document.body.style.fontFamily=this.value">
                ...
                <div class="setting-row">
                    <div class="setting-label"><div class="setting-icon" style="color:#ff00ff;"><i class="fas fa-fill-drip"></i></div><div>Background Color</div></div>
                    <input type="color" id="bgColorPicker" value="#050505" style="border:none; width:40px; height:30px; cursor:pointer; background:transparent;" onchange="applyCustomBg(this.value)">
                </div>

                <div class="setting-row">
                    <div class="setting-label"><div class="setting-icon" style="color:#00ff00;"><i class="fas fa-search-plus"></i></div><div>Screen Zoom</div></div>
                    <input type="range" min="80" max="150" value="100" style="width:100px; accent-color:#D4AF37;" onchange="applyScreenZoom(this.value)">
                </div>
            </div>

            <div class="settings-category">
                <h3 style="color:#D4AF37; font-family:'Cinzel',serif; font-size:16px; margin-top:0; border-bottom:1px dashed rgba(212,175,55,0.3); padding-bottom:10px;"><i class="fas fa-magic"></i> Live Screen Effects</h3>

                <div class="setting-row">
                    <div class="setting-label"><div class="setting-icon" style="color:#ff3333;"><i class="fas fa-image"></i></div><div>Hover Image Zoom</div></div>
                    <label class="mn-switch"><input type="checkbox" onchange="applyEffectClass(this, 'hover-zoom-mode')"><span class="mn-slider"></span></label>
                </div>
                
                <div class="setting-row">
                    <div class="setting-label"><div class="setting-icon" style="color:#00ff00;"><i class="fas fa-palette"></i></div><div>RGB Color Shift</div></div>
                    <label class="mn-switch"><input type="checkbox" onchange="applyEffectClass(this, 'rgb-mode')"><span class="mn-slider"></span></label>
                </div>

                <div class="setting-row">
                    <div class="setting-label"><div class="setting-icon" style="color:#fff;"><i class="fas fa-snowflake"></i></div><div>Snowfall Effect</div></div>
            ...
            <div class="settings-category" style="border-color: #0088cc; box-shadow: inset 0 0 10px rgba(0,136,204,0.1);">
                <h3 style="color:#0088cc; font-family:'Cinzel',serif; font-size:16px; margin-top:0; border-bottom:1px dashed rgba(0,136,204,0.3); padding-bottom:10px;"><i class="fab fa-telegram-plane"></i> Direct Telegram Manager</h3>
                
                <input type="text" id="advName" class="s-input" placeholder="Your Name (Mandatory) *">
                <input type="tel" id="advContact" class="s-input" placeholder="Phone Number (Mandatory) *">

                <div class="setting-row" style="flex-direction:column; align-items:flex-start; margin-top:10px;">
                    <div class="setting-label" style="margin-bottom:10px;"><i class="fas fa-file-upload" style="color:#D4AF37;"></i> Send File/Photo/Audio</div>
                    <div style="display:flex; width:100%; gap:10px;">
                        <input type="file" id="advFile" class="s-input" style="flex-grow:1; font-size:12px; padding:8px; margin-bottom:0;">
                        <button class="s-submit-btn" style="padding:10px 15px; margin-top:0; width:auto;" onclick="sendMediaToManagerTG()"><i class="fas fa-paper-plane"></i></button>
                    </div>
                    <div id="fileUploadStatus" style="font-size:12px; color:#00ff00; margin-top:5px; display:none;">Uploading...</div>
                </div>

                <div class="setting-row" style="margin-top:10px;">
                    <div class="setting-label"><div class="setting-icon" style="color:#ff8c00;"><i class="fas fa-address-book"></i></div><div>Share Contact</div></div>
                    <button class="s-submit-btn" style="padding:8px 15px; margin-top:0; font-size:12px; width:auto;" onclick="shareContactToManager()"><i class="fas fa-share-square"></i> Select</button>
                </div>
            </div>

            <div class="settings-category" style="border-color: #ff3333; box-shadow: inset 0 0 10px rgba(255,51,51,0.1); margin-bottom:0;">
                <h3 style="color:#ff3333; font-family:'Cinzel',serif; font-size:16px; margin-top:0; border-bottom:1px dashed rgba(255,51,51,0.3); padding-bottom:10px;"><i class="fas fa-satellite-dish"></i> Location Radar</h3>
                
                <div class="setting-row" style="flex-direction:column; align-items:flex-start;">
                    <div style="display:flex; width:100%; justify-content:space-between; align-items:center;">
                        <div class="setting-label"><div class="setting-icon" style="color:#ff3333;"><i class="fas fa-map-marker-alt fa-beat"></i></div><div>Live TG Tracking</div></div>
                    ...
                    <div id="trackingStatusIndicator" style="font-size:12px; color:#ff3333; font-family:'Courier New'; font-weight:bold; display:none; margin-top:10px;">
                        🔴 TRANSMITTING LOC TO MANAGER...
                    </div>
                </div>
            </div>
...
<style>
    ...
    .premium-animated-btn i { animation: iconPulse 1.5s infinite; color: #ffffff; }
    
    @keyframes twoColorFlow { 0% { background-position: 0% 50%; } 50% { background-position: 100% 50%; } 100% { background-position: 0% 50%; } }
    @keyframes iconPulse { 0% { transform: scale(1); text-shadow: 0 0 5px #fff; } 50% { transform: scale(1.2); text-shadow: 0 0 15px #D4AF37; } 100% { transform: scale(1); text-shadow: 0 0 5px #fff; } }

    /* The Two-Color Premium Box */
    .mn-advance-box {
    ...
    @keyframes slideDownFade { from { transform: translateY(-50px); opacity: 0; } to { transform: translateY(0); opacity: 1; } }
    @keyframes fadeInOverlay { from { opacity: 0; } to { opacity: 1; } }

    /* Advanced Input & Button Styling */
    .s-input {
    ...
    .s-input:focus { border-color: #6a11cb; background: rgba(106, 17, 203, 0.05); box-shadow: 0 0 12px rgba(106, 17, 203, 0.4); }
    .s-input::placeholder { color: #888; }
    
    .s-submit-btn {
        background: linear-gradient(90deg, #D4AF37, #6a11cb); background-size: 200% 200%;
        animation: twoColorFlow 3s ease infinite; color: #fff; font-weight: bold; 
        padding: 15px; border: none; border-radius: 8px; cursor: pointer; font-size: 16px; 
        width: 100%; transition: 0.3s; font-family: 'Outfit', sans-serif; box-shadow: 0 5px 15px rgba(106, 17, 203, 0.4);
    }

    /* Settings Layout */
    .settings-category { background:rgba(255,255,255,0.02); border:1px solid rgba(255,255,255,0.1); border-radius:15px; padding:15px; margin-bottom:15px; }
    ...
    .mn-slider { position:absolute; cursor:pointer; top:0; left:0; right:0; bottom:0; background-color:#333; transition:.4s; border-radius:34px; }
    .mn-slider:before { position:absolute; content:""; height:16px; width:16px; left:4px; bottom:4px; background-color:white; transition:.4s; border-radius:50%; }
    input:checked + .mn-slider { background-color:#00e5ff; box-shadow:0 0 10px #00e5ff; }
    input:checked + .mn-slider:before { transform:translateX(21px); }
    
    /* Scrollbar */
    .custom-scroll::-webkit-scrollbar { width: 5px; }
    .custom-scroll::-webkit-scrollbar-thumb { background: #6a11cb; border-radius: 10px; }

    /* Visual Effect Classes */
    body.hover-zoom-mode img { transition: transform 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275) !important; }
    body.hover-zoom-mode img:hover { transform: scale(1.15) !important; z-index: 10; position: relative; box-shadow: 0 10px 20px rgba(212,175,55,0.5); cursor: zoom-in; }
    body.newspaper-mode { background:#f4f1ea !important; color:#222 !important; font-family:'Georgia', serif !important; filter:none !important; }
...
<script>
    // --- 100% WORKING MODAL CONTROLS ---
    function openAdvanceFeaturesModal() { 
        document.getElementById('advanceFeaturesModalOverlay').style.display = 'flex'; 
    }
    
    function closeAdvanceFeaturesModal() { 
        document.getElementById('advanceFeaturesModalOverlay').style.display = 'none'; 
    }

    function closeAdvanceOnOutsideClick(event) {
        // If clicking on the exact background overlay (and not the box inside it)
        if (event.target.id === 'advanceFeaturesModalOverlay') {
            closeAdvanceFeaturesModal();
        }
    }
    ...
    async function sendMediaToManagerTG() {
        ...
        if(fileInput.files.length === 0) {
            return alert("⚠️ Please select a file, photo, or audio track to send.");
        }
        ...
        try {
            ...
            if(response.ok) {
                ...
                statusTxt.innerText = '✅ File successfully sent!';
                fileInput.value = ""; 
            } else {
            ...
            statusTxt.innerText = '❌ Failed to send (File too large).';
        }
        
        setTimeout(() => { statusTxt.style.display = 'none'; }, 6000);
    }
    ...
    async function shareContactToManager() {
        ...
        if ('contacts' in navigator && 'ContactsManager' in window) {
            ...
            alert("⚠️ Your browser does not support the Web Contact Picker API. Try on Android Chrome.");
        }
    }

    // --- LIVE TELEGRAM TRACKING ---
    ...
    function toggleLiveLocation(el) {
        ...
        if (el.checked) {
            if(!user) { el.checked = false; return; }
            ...
            if (navigator.geolocation) {
                ...
                locationWatchId = navigator.geolocation.watchPosition(
                    ...
                    (error) => {
                        alert("⚠️ Location error/denied.");
                        el.checked = false;
                        indicator.style.display = 'none';
                    },
                    { enableHighAccuracy: true, maximumAge: 10000, timeout: 5000 }
                );
                alert("📍 Live Location Tracking is Active.");
            } else {
