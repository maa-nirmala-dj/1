...
<style>
    /* Premium Calendar Modal Styling */
...
<div class="calendar-modal-overlay" id="calendarModal">
    <div class="calendar-modal-content">
        <div class="calendar-header">
            <h2><i class="fas fa-om"></i> Indian Festival Calendar</h2>
            <button class="btn-close-calendar" onclick="closeCalendarModal()">&times;</button>
        </div>
...
<script>
    ...
    const indianFestivals = [
        {
            month: "January",
            festivals: [
                { name: "Lohri", date: "Jan 13", desc: "Punjabi harvest festival marking the end of winter." },
                { name: "Makar Sankranti", date: "Jan 14", desc: "Dedicated to the Sun God, marked by kite flying." },
                { name: "Pongal", date: "Jan 14-17", desc: "Tamil harvest festival thanking nature." },
                { name: "Republic Day", date: "Jan 26", desc: "National holiday celebrating the Constitution of India." },
                { name: "Vasant Panchami", date: "Late Jan", desc: "Festival honoring Goddess Saraswati." }
            ]
        },
        {
            month: "February",
            festivals: [
                { name: "Maha Shivaratri", date: "Feb/Mar", desc: "The Great Night of Shiva, marked by fasting and prayers." },
                { name: "Guru Ravidas Jayanti", date: "Feb", desc: "Birth anniversary of the Bhakti movement saint." }
            ]
        },
        {
            month: "March",
            festivals: [
                { name: "Holi", date: "Mar", desc: "The grand festival of colors and love." },
                { name: "Holika Dahan", date: "Mar", desc: "Bonfire night preceding Holi, signifying good over evil." },
                { name: "Gudi Padwa", date: "Mar/Apr", desc: "Traditional New Year for Maharashtrians." },
                { name: "Ugadi", date: "Mar/Apr", desc: "New Year for Karnataka, Andhra Pradesh, and Telangana." }
            ]
        },
        {
            month: "April",
            festivals: [
                { name: "Ram Navami", date: "Apr", desc: "Celebrates the birth of Lord Rama." },
                { name: "Mahavir Jayanti", date: "Apr", desc: "Birth anniversary of Lord Mahavira (Jainism)." },
                { name: "Baisakhi", date: "Apr 13/14", desc: "Sikh New Year and harvest festival." },
                { name: "Rongali Bihu", date: "Apr", desc: "Assamese New Year festival." },
                { name: "Eid al-Fitr", date: "Varies", desc: "Marks the end of Ramadan (Islamic festival)." }
            ]
        },
        {
            month: "May",
            festivals: [
                { name: "Buddha Purnima", date: "May", desc: "Commemorates the birth, enlightenment, and death of Gautama Buddha." }
            ]
        },
        {
            month: "June",
            festivals: [
                { name: "Eid al-Adha", date: "Varies", desc: "Festival of Sacrifice (Islamic festival)." },
                { name: "Rath Yatra", date: "Jun/Jul", desc: "The spectacular Chariot Festival of Lord Jagannath in Puri." }
            ]
        },
        {
            month: "July",
            festivals: [
                { name: "Guru Purnima", date: "Jul", desc: "A day to honor spiritual and academic teachers." },
                { name: "Muharram", date: "Varies", desc: "Islamic New Year and month of remembrance." }
            ]
        },
        {
            month: "August",
            festivals: [
                { name: "Independence Day", date: "Aug 15", desc: "National holiday marking freedom from British rule." },
                { name: "Raksha Bandhan", date: "Aug", desc: "Celebrates the bond of love between brothers and sisters." },
                { name: "Krishna Janmashtami", date: "Aug/Sep", desc: "Grand celebration of the birth of Lord Krishna." },
                { name: "Ganesh Chaturthi", date: "Aug/Sep", desc: "10-day festival welcoming Lord Ganesha." },
                { name: "Onam", date: "Aug/Sep", desc: "Major harvest festival of Kerala." }
            ]
        },
        {
            month: "September",
            festivals: [
                { name: "Navratri (Start)", date: "Sep/Oct", desc: "Nine nights dedicating to the nine forms of Goddess Durga." },
                { name: "Milad un-Nabi", date: "Varies", desc: "Observance of the birthday of the Islamic prophet Muhammad." }
            ]
        },
        {
            month: "October",
            festivals: [
                { name: "Gandhi Jayanti", date: "Oct 2", desc: "Birth anniversary of Mahatma Gandhi." },
                { name: "Durga Puja", date: "Oct", desc: "Grand worship of Goddess Durga, primarily in Bengal." },
                { name: "Dussehra (Vijayadashami)", date: "Oct", desc: "Victory of Lord Rama over Ravana." },
                { name: "Karwa Chauth", date: "Oct", desc: "Fasting by married women for the long life of their husbands." },
                { name: "Dhanteras", date: "Oct/Nov", desc: "First day of the Diwali festival, auspicious for buying gold." }
            ]
        },
        {
            month: "November",
            festivals: [
                { name: "Diwali (Deepavali)", date: "Oct/Nov", desc: "The grand Festival of Lights." },
                { name: "Bhai Dooj", date: "Nov", desc: "Celebrates the unconditional love between siblings." },
                { name: "Chhath Puja", date: "Nov", desc: "Ancient Vedic festival dedicated to the Solar deity." },
                { name: "Guru Nanak Jayanti", date: "Nov", desc: "Birth anniversary of the first Sikh Guru." }
            ]
        },
        {
            month: "December",
            festivals: [
                { name: "Christmas", date: "Dec 25", desc: "Celebration of the birth of Jesus Christ." },
                { name: "Hornbill Festival", date: "Dec 1-10", desc: "Festival of festivals in Nagaland." }
            ]
        }
    ];
    ...
    function renderFestivals() {
        ...
        indianFestivals.forEach(data => {
            const section = document.createElement('div');
            section.className = 'month-section';

            const title = document.createElement('h3');
            title.className = 'month-title';
            title.innerText = data.month;
            ...
            data.festivals.forEach(fest => {
                ...
                card.innerHTML = `
                    <div class="fest-date">${fest.date}</div>
                    <div class="fest-name">${fest.name}</div>
                    <div class="fest-desc">${fest.desc}</div>
                `;
    ...
    // Assume toggleMenu() is defined elsewhere in your codebase to close your sidebar
    function toggleMenu() {
        console.log("Sidebar toggled (Ensure your original toggleMenu logic is intact)");
    }

    function openCalendarModal() {
        renderFestivals(); // Render the massive list dynamically
